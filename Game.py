...
while True:
  ...
  if userInput ==(1):
      ...
      break
  if userInput ==(2):
      print("Correct! littleNext Question. What was the first game to be \nrated mature?")
  ...
  if userInput ==(1):
      print("Correct! Next Question. When was the first video game \ncompetition")
  elif userInput ==(2):
  ...
  if userInput ==(1):
      ...
      print("Congrats on reaching the end")
      break
print("\nThanks for playing!") 
"""
Platformer Game
